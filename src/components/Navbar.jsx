...
import { customerAuth } from "../firebase";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between relative">
            ...
            <div className="hidden lg:flex absolute left-1/2 -translate-x-1/2 items-center space-x-2">
              {["Home", "About Us", "Services", "Contact Us"].map((item) => (
                <Link
                  key={item}
                  to={getPath(item)}
                  className={`px-5 py-2 font-semibold text-base transition-all duration-300 relative group ${
                  ...
                  {item}
                  <span
                    className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-0.5 bg-[#66BB6A] transition-all duration-300 rounded-full ${
                      location.pathname === getPath(item)
                        ? "w-3/4"
            ...
            <button
              ...
              className="lg:hidden p-2 text-[#5D4037]">
          ...
          {/* Mobile Menu */}
          <div
            className={`lg:hidden overflow-hidden transition-all duration-500 ${isMenuOpen ? "max-h-[500px] opacity-100 mt-6" : "max-h-0 opacity-0"}`}>
            <div className="pb-4 space-y-2">
              {["Home", "About Us", "Services", "Contact Us"].map((item) => (
                <Link
                  ...
                  className={`block w-full text-left px-4 py-3 font-semibold rounded-lg transition-colors ${
                    location.pathname === getPath(item)
